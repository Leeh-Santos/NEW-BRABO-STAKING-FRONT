...
contract BraboStaking is ReentrancyGuard {
    ...
    struct StakeInfo {
        ...
        uint256 accruedRewards;  //  already calculated but not yet claimed
    }
    ...
    /**
     *   Calculate pending rewards since last startTime for a user.
    ...
    /**
     *  (contract PICA minus all staked PICA).
     */
    ...
    /**
     *  Get NFT tier boost for a user (mirrors FundMe logic).
     */
